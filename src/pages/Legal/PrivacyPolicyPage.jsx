  ...
  return (
    <div className="bg-[#020817] min-h-screen text-slate-300 font-sans pb-20 pt-24">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button 
          onClick={handleBack}
          className="mb-8 inline-flex items-center px-4 py-2 text-sm font-medium text-secondary bg-secondary/10 hover:bg-secondary/20 border border-secondary/20 rounded-lg transition-colors"
        >
